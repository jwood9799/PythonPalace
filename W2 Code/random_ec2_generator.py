...
print("Thank you, " + (name.capitalize()) + (".") + (" Nice to meet you."))


#get the users department name

dept = input("What department do you work for, " + (name.capitalize()) + ("?") + (" Accounting, Marketing, or FinOps?\n")).upper()
...
while True:
    try:
        ...
        print("I'm sorry, we don't support that department " + (name.capitalize()) + (".") + (" Please check in with your supervisor."))
        exit()
    else: 
        print("Thanks.")
        break
...
while True:
    try:
        instnumb = int(input("How many instances you need? "))
...
print(("Thanks for stopping by, ") + (name.capitalize()) + (". Take care."))